...
<br><br>
<?php if($count = Session::get('count')): ?>
            <div class="alert alert-info alert-block">
                <button type="button" class="close" data-dismiss="alert">×</button>
                <strong>Phim này có <?php echo e($count); ?> chủ đề .Bạn không thể xóa!</strong>
            </div>
<?php endif; ?>
    ...
    <tbody>
        <?php $__currentLoopData = $ds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="text-center">
                ...
                <td> <img src="<?php echo e(asset("images/phim/$item->film_poster")); ?>" width="35%" > </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin-layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\motphim\resources\views/admin/film/index.blade.php ENDPATH**/ ?>