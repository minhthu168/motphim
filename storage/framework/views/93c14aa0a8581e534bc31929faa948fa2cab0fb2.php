        ...
        <div class="row">
            <div class="offset-md-3 col-md-5">
                ...
                <div class="card card-primary">
                    ...
                    <form role="form" action="<?php echo e(url('pages/film/createPost')); ?>" method="post" enctype="multipart/form-data">
...
</html><?php /**PATH C:\xampp\htdocs\motphim\resources\views/pages/film/create.blade.php ENDPATH**/ ?>