...
<div class="container">
    ...
    <div class="row" >
      ...
      <div class="col-md-6" style="margin-bottom:20px;">
        ...
        <p style="color: #ebdcdc"><?php echo e($item->topic_date); ?></p>
...
<?php echo $__env->make('web-layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\motphim\resources\views/pages/topic/topicMod.blade.php ENDPATH**/ ?>