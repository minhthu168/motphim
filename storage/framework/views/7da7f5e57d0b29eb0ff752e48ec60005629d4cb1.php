...
<div class="container" style="overflow: hidden;background-color:gainsboro;">
    <div class="row">
        <div class='col-xs-12 col-sm-8 col-md-8 col-lg-9' style="background-color:rgb(241, 240, 240);padding:10px;">
            <div class="row" style="margin: 10px;">
                ...
                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7" >
                    <h1 style="margin-top: 10px;font-size: 2.5rem;font-weight:bold;">
            ...
            <div class="row ">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"
                    ...
                    <h4 style='margin-bottom: 10px; font-weight: bold;'>Tóm tắt</h4>
                    <br>
                    <p><?php echo e($f->film_synopsis); ?></p><hr>
                    <h4 style='margin-bottom: 10px; font-weight: bold;'>Trailer</h4>
        ...
        <div class="col-xs-8 col-sm-4 col-md-4 col-lg-3">
            <div class="miniCat">
                <div class="pc" style="margin-top: 4%; padding: 7%; background: #fff">
                    <h4><b>Thể loại</b></h4>
                    <hr>
                    ...
                    <a href="<?php echo e(asset("pages/film/the-loai/$item->cat_name")); ?>"><p><?php echo e($item->cat_name); ?></p></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <div class="pc" style="margin-top: 4%; padding: 7%; background: #fff">
                    <h4 ><b>Quốc gia</b></h4>
                    ...
                    <a href="<?php echo e(asset("pages/film/quoc-gia/$item->nation_name")); ?>"><?php echo e($item->nation_name); ?></a><br>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            <div class="pc" style="margin-top: 4%; padding: 7%; background: #fff">
                <h4 ><b>Chủ đề phim mới</b></h4>
                <hr>
                ...
                <p style="font-size: 15px;">
                    <a href="<?php echo e(url('pages/topic/detail/'.$item->topic_id)); ?>">
                        <p style="color:blue;font-weight:bold;font-size:110%;"><?php echo e($item->topic_title); ?></p>
...
<?php echo $__env->make('web-layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\d03\resources\views/pages/film/film_detail.blade.php ENDPATH**/ ?>