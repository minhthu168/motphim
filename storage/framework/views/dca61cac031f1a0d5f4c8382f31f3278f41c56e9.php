...
<div class="container" style="overflow: hidden;background:lightgray;">
    <div class="row">
        <div class='col-xs-12 col-sm-8 col-md-8 col-lg-9' style="padding:10px;background:rgb(241, 240, 240);">
           <h1 style="color:black;font-weight:bold"><?php echo e($news->news_subject); ?></h1> 
           <p style="font-size:150%">Ngày đăng: <?php echo e($news->news_date); ?></p>
           <img src="<?php echo e(asset("images/news-event/$news->news_image")); ?>" width="90%">
           <br>
           <p style="font-family:Cambria
           ; font-size:145%;padding:4% 0;"><?php echo e($news->news_content); ?></p>            
        </div>
            ...
            <div class="pc" style="padding: 5px;" >
                ...
                <p style="font-size: 15px;">
                    <a href="<?php echo e(asset("pages/news/detail/$item->news_id")); ?>">
                        <p style="font-weight:bold;font-size:150%"><?php echo e($item->news_subject); ?></p>
                        <img style="width: 60%; height:90px; " src="<?php echo e(asset("images/news-event/$item->news_image")); ?>">
                    </a>
                </p>
                <hr>
...
<?php echo $__env->make('web-layout.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\motphim\resources\views/pages/news/detail.blade.php ENDPATH**/ ?>