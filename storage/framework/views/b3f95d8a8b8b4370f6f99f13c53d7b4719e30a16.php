...
<body>
    <div class="row">
        <div class="offset-md-3 col-md-6">
            ...
            <div class="card card-primary">
                ...
                <form role="form" action="<?php echo e(url("pages/film/modCrTp")); ?>" method="POST" enctype="multipart/form-data"><?php echo csrf_field(); ?>
                    <div class="card-body">
                        <input type="hidden" name="film_id" id="film_id" value="<?php echo e($film_id); ?>"> 
   ...
   $(document).ready(function(){
    ...
    <?php /**PATH C:\xampp\htdocs\motphim\resources\views/pages/film/mod_createTopic.blade.php ENDPATH**/ ?>